...
export const projects: Project[] = [
  ...
  {
    title: 'Campus Found Mobile',
    category: 'Native Android app',
    description:
      'A native Android lost-and-found app for campus use, separated from the Laravel website and built as a focused student portfolio demo.',
    bullets: [
      'Built guest browsing, item details, search, filters, pull-to-refresh, reporting, profile management, and delete support.',
      'Implemented MVVM, Hilt, Retrofit, Room cache fallback, Coroutines, Flow/StateFlow, and MockAPI synchronization.',
      'Supported optional Firebase Storage image uploads with a demo-friendly base64 fallback.',
    ],
    tech: ['Kotlin', 'Android Views', 'MVVM', 'Hilt', 'Retrofit', 'Room', 'StateFlow', 'Glide'],
    image: '/projects/campus-found-mobile-home.png',
    imageAlt: 'Campus Found Mobile home screen displaying lost-and-found posts.',
  ...
  },
  {
    ...
    description:
      'A responsive private-letter platform for writing styled digital letters, publishing expiring private links, and saving offline keepsakes.',
    bullets: [
      'Built public pages, creator workspaces, draft management, private recipient links, reactions, replies, and keepsake downloads.',
      'Added admin tools for users, settings, feedback, moderation, storage limits, expiry options, audit logs, and deployment health.',
      'Deployed with Laravel, MySQL, Resend, queues, scheduler, Nginx, PHP-FPM, Certbot, and DigitalOcean.',
    ],
    tech: ['Laravel', 'PHP', 'MySQL', 'Blade', 'Bootstrap 5', 'Sanctum', 'Resend', 'DigitalOcean'],
